...
Meilleur solution : créer un nouvel environnement juste pour ça, définir `create_counter()` dedans pour que ça devienne son *enclosing environment*, et y stocker `n`. Seuls les compteurs auront accès à `n`.
