...
*Conseil : utiliser les fonctions `mean()`, `range()` et `t.test()` (cette dernière avec un seul argument).*
...
Reprendre l'exemple précédent, mais utiliser une fonction arbitraire fournie par l'utilisateur pour faire l'imputation. Du coup la fonction arbitraire prend peut-être d'autres arguments arbitraires ?
