...
```
*Cas concret : compter un nombre de séjours en comptant le nombre de lignes avec `n()` et le nombre de patients avec `n_distinct()` sur la variable identifiant les patients, un patient pouvant effectuer plusieurs séjours.*
